...
interface CreateSiteModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: LocalSiteCreate) => Promise<void>;
}
...
export default function CreateSiteModal({
    ...
    const defaultFormData: LocalSiteCreate = {
        site_code: "",
        site_name: "",
    ...
    const [formData, setFormData] = useState<LocalSiteCreate>(defaultFormData);
                ...
                <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                            Fill in the site details across all sections below.
                        </Typography>
                    </Box>
                </Box>
                <IconButton
